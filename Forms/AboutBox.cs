...
namespace OSPE.Forms
{
    partial class AboutBox : Form
    {
        public AboutBox()
        {
            ...
            this.labelCopyright.Text = "Created by Elecyb";
            this.labelCompanyName.Text = AssemblyCopyright + " " + AssemblyCompany;
        }
        ...
        private void picWww_Click(object sender, EventArgs e)
        {
            Process.Start("http://www.electrocyber.net/ospe");
        }
    }
}

...
void HookPutty()
{
	...
	if (text.dwSize == 0 || text.dwStartAddress == 0)
	{
		Utils::errorLog("[ERROR] Cannot get Putty section!");
		return;
	}
	...
	Utils::errorLog("[ERROR] Cannot get Putty functions!");
}
...
void HookWinSCP()
{
	...
	if (text.dwSize == 0 || text.dwStartAddress == 0)
	{
		Utils::errorLog("[ERROR] Cannot get WinSCP section!");
		return;
	}
	...
	if (pSend == 0 || pRecv == 0)
	{
		Utils::errorLog("[ERROR] Cannot get WinSCP functions!");
		return;
	}
...
void HookSlack()
{
	...
	if (text.dwSize == 0 || text.dwStartAddress == 0)
	{
		Utils::errorLog("[ERROR] Cannot get Slack section!");
		return;
	}
	...
	if (pSend == 0 || pRecv == 0)
	{
		Utils::errorLog("[ERROR] Cannot get Slack functions!");
		return;
	}
